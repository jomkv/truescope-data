...
def clean_article(article: dict) -> dict:
    """
    Clean and standardize a single Manila Bulletin article dictionary for real-time processing.
    """
...
def clean_mb_articles(input_path, output_path):
    """
    Clean articles JSON and save ONLY to processed file.
    """
    if output_path is None:
...
if __name__ == "__main__":
    ...
    raw_file = os.path.join(
        os.path.dirname(__file__), "../data/raw/articlesManilaBulletin.json"
    )
    processed_file = os.path.join(
        os.path.dirname(__file__), "../data/processed/articlesManilaBulletin.json"
    )
