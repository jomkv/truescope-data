...
class VerdictNormalizer:
    ...
    def normalize_verdict(self, verdict: Optional[str], claim_text: Optional[str] = None) -> Optional[str]:
        ...
        false_starts = ["incorrect.", "false.", "inaccurate.", "wrong.", "untrue.", "not true.", "this is not true"]
        ...
        if verdict_cleaned.startswith("there is no evidence") or verdict_cleaned.startswith("there isn't evidence"):
            return "UNPROVEN"
        ...
        if verdict_cleaned.startswith("we can find no evidence") or verdict_cleaned.startswith("we could find no evidence"):
            return "UNPROVEN"
        ...
        if "matter of judgement" in verdict_cleaned or "matter of judgment" in verdict_cleaned:
            return "UNPROVEN"
        ...
        if verdict_cleaned.startswith("between ") and ("made a number of" in verdict_cleaned or "made several" in verdict_cleaned):
        ...
        if ("correct" in verdict_cleaned or "true" in verdict_cleaned) and any(phrase in verdict_cleaned for phrase in misleading_contradictions):
            return "MISLEADING"
        ...
        if (any(pattern in verdict_cleaned for pattern in partial_support_patterns) and 
            any(qual in verdict_cleaned for qual in magnitude_qualifiers)):
            return "MOSTLY-TRUE"
    ...
    def _classify_with_nlp(self, verdict_text: str, claim_text: Optional[str] = None) -> str:
        """
