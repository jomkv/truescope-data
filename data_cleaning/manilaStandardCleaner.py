...
def clean_article(article: dict) -> dict:
    """
    Clean and standardize a single Manila Standard article dictionary for real-time processing.
    """
...
def clean_ms_articles(input_path, output_path):
    """
...
if __name__ == "__main__":
    ...
    raw_file = os.path.join(
        os.path.dirname(__file__), "../data/raw/articlesManilaStandard.json"
    )
    processed_file = os.path.join(
        os.path.dirname(__file__), "../data/processed/articlesManilaStandard.json"
    )
    ...
    print("\nCLEANING ARTICLES...")
    count = clean_ms_articles(raw_file, processed_file)
