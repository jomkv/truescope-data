...
def clean_frontpage_articles(input_path, output_path):
    ...
    for article in articles:
        ...
        if article.get("source_bias") in (None, ""):
            article["source_bias"] = "LEFT-CENTER"
...
if __name__ == "__main__":
    ...
    raw_file = os.path.join(
        os.path.dirname(__file__), "../data/raw/articlesVerafilesNews.json"
    )
    processed_file = os.path.join(
        os.path.dirname(__file__), "../data/processed/articlesVerafilesNews.json"
    )
