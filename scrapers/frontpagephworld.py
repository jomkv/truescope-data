...
def collect_and_scrape_listing(listing_url):
    print(f"Starting FrontpagePH World scraper with real-time DB integration...")
    ...
    with sync_playwright() as p:
        ...
        while True:
            ...
            if current_page % 5 == 0:
                print(f"Restarting browser at page {current_page} for memory management")
                try:
                    browser.close()
                except Exception:
                    pass
...
def main():
    LISTING_URL = "https://frontpageph.com/category/world/"
